...
CREATE NONCLUSTERED INDEX idx_nc_categoryid  ON dbo.Products(categoryid);
CREATE NONCLUSTERED INDEX idx_nc_productname ON dbo.Products(productname);
CREATE NONCLUSTERED INDEX idx_nc_supplierid  ON dbo.Products(supplierid);
...
CREATE NONCLUSTERED INDEX idx_nc_city        ON dbo.Customers(city);
CREATE NONCLUSTERED INDEX idx_nc_companyname ON dbo.Customers(companyname);
CREATE NONCLUSTERED INDEX idx_nc_postalcode  ON dbo.Customers(postalcode);
CREATE NONCLUSTERED INDEX idx_nc_region      ON dbo.Customers(region);
...
CREATE NONCLUSTERED INDEX idx_nc_orderid   ON dbo.OrderDetails(orderid);
CREATE NONCLUSTERED INDEX idx_nc_productid ON dbo.OrderDetails(productid);
