#pragma checksum "I:\Company\MensClothe\App_Code\Order\OrderClass.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "73B2BC523A46E1B286711B0DA8845E6F07DDA9FC"

#line 1 "I:\Company\MensClothe\App_Code\Order\OrderClass.cs"
using DAL;
...
public class OrderClass
{
  ...
  //  private bool PayPalReturnRequest = false;
    ...
    public void HandlePayPalRedirection()
    {
        ...
        //PayPal.LogoUrl = "http://localhost:30578/MensClothe/images/Company_Logo.jpg";

        PayPal.ItemName = "Men's Online Store-MenStore.lk Invoice #" + new Guid().GetHashCode().ToString("x");
