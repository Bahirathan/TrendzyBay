...
namespace @__ASP {
    ...
    internal class FastObjectFactory_app_web_owtp5ooj {
        ...
        private FastObjectFactory_app_web_owtp5ooj() {
        }
        
        static object Create_ASP__Page_Admin_Admin_cshtml() {
            return new ASP._Page_Admin_Admin_cshtml();
        }
    }
}
